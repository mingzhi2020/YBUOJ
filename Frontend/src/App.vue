<template>
  <div id="app"
    ...
    <div class="footer">
      <p>
        Powered by
        <a href="https://github.com/mingzhi2020"
           target="_blank"
           style="text-decoration: none;color:#409EFF;">shiyu huang</a>
        <span>
          &nbsp; Version: 1.0&nbsp;&nbsp; Docs:&nbsp;&nbsp;
          <a href=""
             target="_blank"
             style="text-decoration: none;color:#409EFF;">YBUOJ Docs</a>&nbsp;&nbsp;欢迎加入YBUOJ讨论群: 1169797152&nbsp;&nbsp;
          <a target="_blank"
             href="https://jq.qq.com/?_wv=1027&k=G2xEVXQa">
            <img border="0"
